...
try {
  ...
  $r = Invoke-WebRequest -Uri 'https://20260704155001.vercel.app/api/import-tasks' -Method POST -ContentType "multipart/form-data; boundary=$boundary" -Body $bodyBytes -UseBasicParsing -TimeoutSec 60
  $sw.Stop()
